      ...
      <div className="grid gap-4 md:grid-cols-[1.3fr_1fr_1fr]">
        ...
        <label className="block">
          ...
          <select
            ...
            className="mt-2 w-full rounded-lg border border-stone-200 bg-stone-50 px-4 py-3 text-base outline-none focus:border-forest-500 focus:bg-white disabled:opacity-60"
          >
